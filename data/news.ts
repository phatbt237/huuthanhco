...
export const news: NewsItem[] = [
  {
    ...
    content: `<img src="/images/tin-tuc/ha-thuy-sa-lan-chuyen-dung-01.jpg" alt="Sà lan chuyên dụng Hữu Thành trong ngày hạ thủy" title="Hình ảnh: Sà lan chuyên dụng của Công ty Cổ phần Xây dựng Hữu Thành trong ngày hạ thủy thành công 11/7/2026 tại TP.HCM.">
<p>Sà lan chuyên dụng được hạ thủy có chiều dài 58,25m, chiều rộng 18,25m, chiều cao mạn 3,20 m, chiều chìm thiết kế 2,40m, tổng dung tích 906 GT, trọng tải toàn phần trên 2.000 tấn. Với mặt boong rộng và tải trọng lớn, sà lan sẽ được lắp đặt cần cẩu 250 tấn để đáp ứng năng lực phục vụ thi công các công trình, dự án lớn trên biển.</p>
<img src="/images/tin-tuc/ha-thuy-sa-lan-chuyen-dung-02.jpg" alt="Toàn cảnh quá trình hạ thủy sà lan chuyên dụng" title="Hình ảnh: Toàn cảnh quá trình hạ thủy sà lan chuyên dụng của Hữu Thành.">
<p>Quá trình hạ thủy được đội ngũ kỹ sư, cán bộ kỹ thuật và công nhân phối hợp triển khai chặt chẽ, tuân thủ phương án kỹ thuật và các yêu cầu an toàn. Sà lan rời triền, tiếp nước ổn định và được đưa về vị trí neo đậu an toàn, hoàn tất thành công các bước quan trọng của kế hoạch hạ thủy.</p>
<p>Việc đưa Sà lan chuyên dùng mới vào khai thác giúp Hữu Thành chủ động hơn về phương tiện thiết bị phục vụ thi công các công trình, dự án cảng biển. Đây cũng là bước đầu tư quan trọng nhằm tăng cường năng lực thiết bị thi công đáp ứng các dự án quy mô lớn trong thời gian tới.</p>
<p>Sự kiện hạ thủy thành công sà lan chuyên dùng tiếp tục khẳng định định hướng chú trọng đầu tư trang thiết bị thi công, phát triển đội ngũ thiết bị thi công thủy của Công ty Cổ phần Xây dựng Hữu Thành. Với nền tảng thiết bị ngày càng lớn mạnh cùng đội ngũ cán bộ, kỹ thuật giàu kinh nghiệm, Hữu Thành sẵn sàng đồng hành trong những công trình, dự án giao thông hàng hải lớn, trọng điểm, qua đó góp phần tạo nên các giá trị bền vững cho cộng đồng và xã hội.</p>
<figure class="news-video news-video--vimeo" data-provider="vimeo" data-video-id="1210381764"><figcaption>Video: Toàn cảnh hạ thủy sà lan chuyên dụng Hữu Thành.</figcaption></figure>`,
    contentEn: `<img src="/images/tin-tuc/ha-thuy-sa-lan-chuyen-dung-01.jpg" alt="Huu Thanh specialized barge on launch day" title="Image: Huu Thanh Construction Joint Stock Company's specialized barge during its successful launch in Ho Chi Minh City on July 11, 2026.">
<p>The specialized barge has a length of 58.25 m, a width of 18.25 m, a moulded depth of 3.20 m, a design draught of 2.40 m, a gross tonnage of 906 GT, and a total deadweight of over 2,000 tonnes. With its wide deck and large load capacity, the barge will be fitted with a 250-tonne crane to serve major offshore construction works and projects.</p>
<img src="/images/tin-tuc/ha-thuy-sa-lan-chuyen-dung-02.jpg" alt="Overview of the specialized barge launch" title="Image: Overview of Huu Thanh's specialized barge launch.">
<p>The launch was closely coordinated by engineers, technical staff, and workers in compliance with the approved technical method and safety requirements. The barge left the slipway, entered the water stably, and was moved to a safe anchorage, successfully completing the key stages of the launch plan.</p>
<p>Putting the new specialized barge into operation gives Huu Thanh greater control over the equipment used for port and maritime construction projects. It is also an important investment that strengthens the company's construction equipment capacity for larger-scale projects in the years ahead.</p>
<p>The successful launch further affirms Huu Thanh Construction Joint Stock Company's focus on investing in construction equipment and developing its marine construction fleet. With an increasingly robust equipment base and an experienced technical team, Huu Thanh is ready to contribute to major and nationally significant maritime transport projects, creating sustainable value for communities and society.</p>
<figure class="news-video news-video--vimeo" data-provider="vimeo" data-video-id="1210381764"><figcaption>Video: Overview of the Huu Thanh specialized barge launch.</figcaption></figure>`,
  },
  {
    id: "2",
