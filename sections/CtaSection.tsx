  ...
  return (
    <section className="relative py-28 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
        ...
        >
          <span className="inline-block text-sky-600 text-xs font-bold uppercase tracking-widest mb-6 border border-sky-600/30 px-4 py-2 rounded-full">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/lien-he"
              className="group flex items-center gap-2 bg-sky-600 hover:bg-sky-700 text-white px-8 py-4 rounded font-semibold text-base transition-all duration-200"
            >
              {t("Liên hệ tư vấn", "Get a Consultation")}
              <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />
            </Link>
            <a
              href="tel:02873093068"
