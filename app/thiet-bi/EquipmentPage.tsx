    ...
    <>
      ...
      <section style={{ backgroundColor: "#0D1B2A" }} className="relative py-32">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <span className="text-orange-400 text-xs font-bold uppercase tracking-widest">Phương tiện & Máy móc</span>
            <h1 className="text-4xl md:text-5xl font-bold text-white mt-4">Thiết bị thi công</h1>
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-2 border-t border-slate-200 pt-4">
                    <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Thông số kỹ thuật</p>
                    {item.specs.map((spec) => (
