    ...
    <>
      <section className="relative bg-slate-950 py-28">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <span className="text-xs font-bold uppercase tracking-[0.25em] text-orange-400">{t("Tìm kiếm", "Search")}</span>
          <h1 className="mt-4 text-4xl font-bold text-white md:text-5xl">{t("Kết quả tìm kiếm", "Search Results")}</h1>
          <p className="mt-4 max-w-2xl text-lg text-white/65">
            {query
              ? `${t("Từ khóa", "Keyword")}: "${query}"`
              : t("Nhập từ khóa trên thanh tìm kiếm để xem kết quả liên quan.", "Enter a keyword in the search bar to view related results.")}
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          {results.length > 0 ? (
            ...
            <div className="border border-slate-200 p-10 text-center">
              ...
              <h2 className="text-xl font-bold text-slate-950">{t("Không tìm thấy kết quả phù hợp", "No matching results found")}</h2>
              <p className="mt-3 text-slate-500">
                {t(
                  "Thử tìm bằng từ khóa khác như “dự án”, “thiết bị”, “nạo vét”, “hồ sơ năng lực”.",
                  "Try another keyword such as “projects”, “equipment”, “dredging”, or “company profile”."
                )}
              </p>
            </div>
          )}
